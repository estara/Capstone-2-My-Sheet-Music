...
async function commonBeforeAll() {
  ...
  testLibraryIds[0] = (await Library.create(
      {
        title: "w1",
        composer: "C1",
        genre: "Chant",
  ...
  testLibraryIds[1] = (await Library.create(
    {
      title: "w2",
      composer: "C2",
      genre: "Symphony",
  ...
  testLibraryIds[2] = (await Library.create(
    {
      title: "w3",
      composer: "C3",
      genre: "Opera",
  ...
  testLibraryIds[3] = (await Library.create({
    title: "w4",
      composer: "C3",
      genre: "Keyboard",
      birth: "1930-03-03",
  ...
  testWorksOwnedIds[0] = (await UserLibrary.create(
      { owned: false, digital: false, physical: true, played: false, loanedout: true, notes: "note1", api_id: null, library_id: testLibraryIds[3], user_id: testUserIds[0]})).id;
  testWorksOwnedIds[1] = (await UserLibrary.create(
      { owned: true, digital: true, physical: true, played: true, loanedout: false, notes: null, api_id: null, library_id: testLibraryIds[0], user_id: testUserIds[1] })).id;
  testWorksOwnedIds[2] = (await UserLibrary.create(
